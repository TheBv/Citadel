...
public class VanillaTabulaModel implements IUnbakedModel {
    ...
    public VanillaTabulaModel(TabulaModelContainer model, RenderMaterial particle, ImmutableList<RenderMaterial> textures, ImmutableMap<TransformType, TransformationMatrix> transforms) {
        this.model = model;
